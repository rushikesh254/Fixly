...
function Trust() {
  return (
    <div
      ...
      w-[calc(100%-2rem)] sm:w-[90%] md:w-[60%] max-w-4xl
    ...
    >
      ...
      <div className="flex flex-col items-center flex-1">
        <h1 className="flex items-center gap-1 text-2xl text-white font-bold">
          4.8 <FaStar className="text-yellow-300" aria-hidden="true" />
        </h1>
        <p className="text-center text-xs md:text-sm text-blue-200">
          Average Rating
        </p>
